...
#' "Gold-Standard" R-loop sites defined by Chedin et al. 
...
#' A named list that is generated by running RLSeq() containing all results from 
#' the pipeline for the sample SRX1025890.
"SRX1025890"
