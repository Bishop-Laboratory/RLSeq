#' Get RLFS
#'
#' Helper function which obtains RLFS for a given genome.
#' @param genome the UCSC genome for which to download RLFS
#' @return A GRanges object of RLFS.
getRLFS <- function(genome) {
  RLFS <- regioneR::toGRanges(paste0(
