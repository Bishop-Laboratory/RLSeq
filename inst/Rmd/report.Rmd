...
<img src="logo.png" align="right" alt="logo" width="220" style = "border: none; float: right;">
...
res_order <- c(
  "rlfsRes", "predictRes", "featureEnrichment", 
  "correlationMat", "geneAnnoRes", "rlRegionRes"
)
funcs <- c(
  "analyzeRLFS", "predictCondition", "featureEnrich", 
...
> Miller et al., RLSeq, (2021), GitHub repository, [Bishop-Laboratory/RLSeq](https://github.com/Bishop-Laboratory/RLSeq)
