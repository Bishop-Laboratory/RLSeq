...
read_qc <- tibble::tibble(
  "attribute" = namestable,
  "Before filtering" = before_filter,
  "After filtering" = after_filter
) %>%
  dplyr::mutate_at(.vars = c("Before filtering", "After filtering"), function(x) {
...
kableExtra::kable(read_qc) %>%
  kableExtra::kable_styling(full_width = FALSE,
                            position = "left", bootstrap_options = "striped")
```
